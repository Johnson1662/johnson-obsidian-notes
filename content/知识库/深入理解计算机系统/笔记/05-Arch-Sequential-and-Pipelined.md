...
![seq_inst_stages_1](/05-Arch-Sequential-and-Pipelined/seq_inst_stages_1.png)
...
![seq_inst_stages_2](/05-Arch-Sequential-and-Pipelined/seq_inst_stages_2.png)
...
![seq_inst_stages_3](/05-Arch-Sequential-and-Pipelined/seq_inst_stages_3.png)
...
![seq_inst_stages_4](/05-Arch-Sequential-and-Pipelined/seq_inst_stages_4.png)
...
![seq_hardware](/05-Arch-Sequential-and-Pipelined/seq_hardware.png)
...
![pipe_limit_1](/05-Arch-Sequential-and-Pipelined/pipe_limit_1.png)


![pipe_limit_2](/05-Arch-Sequential-and-Pipelined/pipe_limit_2.png)
...
![seq+_pc](/05-Arch-Sequential-and-Pipelined/seq+_pc.png)
...
![seq+_hardware](/05-Arch-Sequential-and-Pipelined/seq+_hardware.png)
...
![pipe-_hardware](/05-Arch-Sequential-and-Pipelined/pipe-_hardware.png)
...
- 等价于在 SEQ+ 中插入了流水线寄存器 **（他们都是即将由对应阶段进行处理）**
 - F：Fetch，取指阶段
 - D：Decode，译码阶段
 - E：Execute，执行阶段
 - M：Memory，访存阶段
...
![data_hazard](/05-Arch-Sequential-and-Pipelined/data_hazard.png)
...
![stall](/05-Arch-Sequential-and-Pipelined/stall.png)
...
![stall_vs_bubble](/05-Arch-Sequential-and-Pipelined/stall_vs_bubble.png)
...
![data_hazard_2](/05-Arch-Sequential-and-Pipelined/data_hazard_2.png)
...
![forward_1](/05-Arch-Sequential-and-Pipelined/forward_1.png)


![forward_2](/05-Arch-Sequential-and-Pipelined/forward_2.png)
...
![load_use_hazard](/05-Arch-Sequential-and-Pipelined/load_use_hazard.png)
...
![load_use_hazard_solution](/05-Arch-Sequential-and-Pipelined/load_use_hazard_solution.png)
...
![pipe_hardware](/05-Arch-Sequential-and-Pipelined/pipe_hardware.png)
...
![control_hazard_ret](/05-Arch-Sequential-and-Pipelined/control_hazard_ret.png)
...
![control_hazard_jxx](/05-Arch-Sequential-and-Pipelined/control_hazard_jxx.png)
...
![pipeline_fetch_stage](/05-Arch-Sequential-and-Pipelined/pipeline_fetch_stage.png)
...
![pipeline_decode_stage](/05-Arch-Sequential-and-Pipelined/pipeline_decode_stage.png)
...
![pipeline_execute_stage](/05-Arch-Sequential-and-Pipelined/pipeline_execute_stage.png)
...
![pipeline_memory_stage](/05-Arch-Sequential-and-Pipelined/pipeline_memory_stage.png)
...
![load_use_hazard_solution_stall](/05-Arch-Sequential-and-Pipelined/load_use_hazard_solution_stall.png)


![control_hazard_ret_stall](/05-Arch-Sequential-and-Pipelined/control_hazard_ret_stall.png)
...
![control_hazard_jxx_bubble_1](/05-Arch-Sequential-and-Pipelined/control_hazard_jxx_bubble_1.png)


![control_hazard_ret_bubble](/05-Arch-Sequential-and-Pipelined/control_hazard_ret_bubble.png) 
...
![control_hazard_jxx_bubble_2](/05-Arch-Sequential-and-Pipelined/control_hazard_jxx_bubble_2.png)


![load_use_hazard_solution_bubble](/05-Arch-Sequential-and-Pipelined/load_use_hazard_solution_bubble.png)
...
![special_condition](/05-Arch-Sequential-and-Pipelined/special_condition.png)
...
![combination_a](/05-Arch-Sequential-and-Pipelined/combination_a.png)
...
![combination_b](/05-Arch-Sequential-and-Pipelined/combination_b.png)
