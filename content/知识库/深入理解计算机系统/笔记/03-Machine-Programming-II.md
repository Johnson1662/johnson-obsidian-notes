...
![栈帧结构图](assets/03-Machine-Programming-II/stack-frame.png)
...
![call 和 ret 指令](assets/03-Machine-Programming-II/call-and-ret.png)
...
![参数构造区](assets/03-Machine-Programming-II/params.png)
...
合并：声明 `p` 为一个包含 2 个元素的 数组 ，每个元素是 指向一个包含 3 个元素的 数组 的指针 </span>， 这些数组的元素是指向 `int` 类型的指针 。
...
![sizeof](/03-Machine-Programming-II/sizeof.svg)
...
![alignment](assets/03-Machine-Programming-II/alignment.png)
...
![alignment-2](assets/03-Machine-Programming-II/alignment-2.png)
