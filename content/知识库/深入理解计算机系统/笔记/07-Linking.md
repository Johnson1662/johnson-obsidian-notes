...
$$
\text \xrightarrow{\text{cpp}} \text \xrightarrow{\text{cc1}} \text \xrightarrow{\text{as}} \text \xrightarrow{\text{ld}} \text{prog}
$$
...
![static_linking](/07-Linking/static_linking.png)
...
`.symtab`：符号表 （symbol table），存放定义和引用的函数与全局变量信息
...
- `R_X86_64_32`：重定位一个使用 32 位 **绝对地址** 的引用
...
![relocate_relative](/07-Linking/relocate_relative.png)
...
![relocate_absolute](/07-Linking/relocate_absolute.png)
...
![executable_object_file](/07-Linking/executable_object_file.png)
...
![runtime_memory](/07-Linking/runtime_memory.png)
...
![dynamic_linking](/07-Linking/dynamic_linking.png)
