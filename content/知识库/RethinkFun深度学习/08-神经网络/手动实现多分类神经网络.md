---
title: 手动实现多分类神经网络
source: https://www.rethink.fun/chapter8/%E6%89%8B%E5%8A%A8%E5%AE%9E%E7%8E%B0%E5%A4%9A%E5%88%86%E7%B1%BB%E7%A5%9E%E7%BB%8F%E7%BD%91%E7%BB%9C.html
chapter: 08-神经网络
...
通过上边的代码我们定义和初始化了每一层的权重和偏置参数。注意权重参数我们是在标准的正态分布基础上，乘以$\sqrt{\frac{2}{in\_size}}$in_size2​​来进行初始化。
...
注意这里softmax的实现有个小的技巧，为了防止输入的值过大，比如1000，e的1000次方就超过float的表示范围了。解决办法是给softmax函数的分子分母同时除以$e^{x.max}$ex.max，这就等于指数部分相减torch.exp(x-x.max)。
