---
title: 手动实现多分类神经网络
source: https://www.rethink.fun/chapter8/手动实现多分类神经网络.html
chapter: 08-神经网络
...
通过上边的代码我们定义和初始化了每一层的权重和偏置参数。注意权重参数我们是在标准的正态分布基础上，乘以2in_size\sqrt{\frac{2}{in\_size}}in_size2​​来进行初始化。
