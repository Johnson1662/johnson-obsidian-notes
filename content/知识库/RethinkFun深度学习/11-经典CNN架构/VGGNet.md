---
title: VGGNet
source: https://www.rethink.fun/chapter11/VGGNet.html
chapter: 11-经典CNN架构
...
- 
参数量更少，假如输入通道数为CinC_{in}Cin​,输出通道数为CoutC_{out}Cout​，则两个3×3卷积核的参数量为2×3×3×Cin×Cout2\times3\times3\times C_{in}\times C_{out}2×3×3×Cin​×Cout​，等于18CinCout18C_{in}C_{out}18Cin​Cout​。一个5×5卷积核的参数量为5×5×Cin×Cout5\times 5 \times C_{in} \times C_{out}5×5×Cin​×Cout​，等于25CinCout25C_{in}C_{out}25Cin​Cout​。
