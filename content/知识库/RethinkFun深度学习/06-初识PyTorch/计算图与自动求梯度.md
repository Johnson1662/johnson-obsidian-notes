---
title: 计算图与自动求梯度
source: https://www.rethink.fun/chapter6/%E8%AE%A1%E7%AE%97%E5%9B%BE%E4%B8%8E%E8%87%AA%E5%8A%A8%E6%B1%82%E6%A2%AF%E5%BA%A6.html
...
$z = log\left ( 3x+4y \right ) ^2$z=log(3x+4y)2
下边，我们需要计算梯度，分别对x和y求偏导。首先分析这个计算式，可以发现它是一个3重的复合函数，分别为：
$z = f(u) = logu$z=f(u)=logu

$u = g(v) = v^2$u=g(v)=v2

$v = h(x,y) = 3x+4y$v=h(x,y)=3x+4y
...
接下来利用链式求导法则，对x求偏导数：
$\frac{\partial z}{\partial x} =\frac{\partial z}{\partial u}\frac{\partial u}{\partial v}\frac{\partial v}{\partial x}$∂x∂z​=∂u∂z​∂v∂u​∂x∂v​

$\frac{\partial z}{\partial x}=\frac{1}{\left ( 3x+4y \right ) ^2}\cdot2(3x+4y)\cdot3$∂x∂z​=(3x+4y)21​⋅2(3x+4y)⋅3

同理，我们可以得到对y的偏导为：
$\frac{\partial z}{\partial y}=\frac{1}{\left ( 3x+4y \right ) ^2}\cdot2(3x+4y)\cdot4$∂y∂z​=(3x+4y)21​⋅2(3x+4y)⋅4

当x=1，y=1时，则z对x，y的偏导数约为：
$\frac{\partial z}{\partial x}\approx 0.8571$∂x∂z​≈0.8571

$\frac{\partial z}{\partial y}\approx 1.1429$∂y∂z​≈1.1429
