...
## 4. 关系数据模型（Relational Data Model）
...
| **日期**  | `DATE`                      | 日期，如 `'1948-05-14'`                               |
| **时间**  | `TIME`                      | 时间，如 `'15:00:02.5'`                               |
