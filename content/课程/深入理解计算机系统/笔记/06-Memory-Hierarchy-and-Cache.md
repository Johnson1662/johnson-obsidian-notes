...
![sram](/06-Memory-Hierarchy-and-Cache/sram.png)
...
![dram_core](/06-Memory-Hierarchy-and-Cache/dram_core.png)
...
![dram_supercell](/06-Memory-Hierarchy-and-Cache/dram_supercell.png)
...
![dram_ras_cas](/06-Memory-Hierarchy-and-Cache/dram_ras_cas.png)
...
![sdram](/06-Memory-Hierarchy-and-Cache/sdram.png)
...
![ddrm](/06-Memory-Hierarchy-and-Cache/ddrm.png)
...
![disk_structure](/06-Memory-Hierarchy-and-Cache/disk_structure.png)
...
![disk_traditional](/06-Memory-Hierarchy-and-Cache/disk_traditional.svg)

![disk_multi_zone](/06-Memory-Hierarchy-and-Cache/disk_multi_zone.svg)
...
![disk_seek](/06-Memory-Hierarchy-and-Cache/disk_seek.png)


寻道时间：$T_{\text{seek}}$


![disk_rotate](/06-Memory-Hierarchy-and-Cache/disk_rotate.png)
...
![thrashing](/06-Memory-Hierarchy-and-Cache/thrashing.svg)
...
![cache_direct_mapped](/06-Memory-Hierarchy-and-Cache/cache_direct_mapped.png)

![cache_set_associative](/06-Memory-Hierarchy-and-Cache/cache_set_associative.png)

![cache_fully_associative](/06-Memory-Hierarchy-and-Cache/cache_fully_associative.png)
...
（需要额外的 1 位 dirty bit 来标识缓存中数据是否被修改）
...
![memory_hill](/06-Memory-Hierarchy-and-Cache/memory_hill.png)
