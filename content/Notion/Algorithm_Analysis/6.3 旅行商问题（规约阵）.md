...
救急视频：[7.3 旅行商问题 - 分支界限法_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1iTGbzsEfP/?spm_id_from=333.337.search-card.all.click&vd_source=7675af15891f3aabbc21b6f21ceaaf33)
...
跳过。
    - **扩展分支**：生成所有可能的子节点。
    - **更新规约矩阵**：为每个子节点计算新的规约矩阵和下界。
    - **更新最优解**：若子节点为完整路径且成本更小，更新 UB
3. **终止条件**：队列为空，输出最优解。
